...
export const signUpVenue = async (email, password) => {
    try{
        const response = await fetch(`https://bartist-backend.vercel.app/venues/signUp`, 
        {
            method: 'POST',
            headers: {
...
export const signInVenue = async (email, password) => {
    try{
        const response = await fetch(`https://bartist-backend.vercel.app/venues/signIn`, 
        {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
...
export const updateProfilVenue = async ( 
    ...
    try{
        ...
        const response = await fetch(`https://bartist-backend.vercel.app/venues/createProfile/${token}`, 
        {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
...
export const getVenueById = async (id) => {
    try{
      const response = await fetch(`https://bartist-backend.vercel.app/venues/id/${id}`, {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
        },
  ...
  export const getVenueByToken = async (token) => {
    try{
      const response = await fetch(`https://bartist-backend.vercel.app/venues/token/${token}`, {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
        },
