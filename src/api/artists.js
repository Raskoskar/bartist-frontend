...
export const signUpArtist = async (email, password) => {
  try {
    const response = await fetch(`https://bartist-backend-raskoskars-projects.vercel.app/artists/signUp`, {
      method: "POST",
      headers: {
...
export const signInArtist = async (email, password) => {
  try {
    const response = await fetch(`https://bartist-backend-raskoskars-projects.vercel.app/artists/signIn`, {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
