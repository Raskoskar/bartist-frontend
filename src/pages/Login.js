  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Bartist est une plateforme qui connecte les artistes avec les établissements pour organiser des événements inoubliables. Que vous soyez un artiste en quête de scène ou un établissement à la recherche de talents, rejoignez-nous !"
        />
        <meta
          name="keywords"
          content="Bartist, artiste, établissement, événement, musique, scène, talents"
        />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <link rel="icon" href="/favicon.ico" />

        {/* Balise Canonical */}
        <link rel="canonical" href="https://www.votre-site.com/login" />
      </Head>
        ...
        <main className={styles.main}>
          ...
          <div className={styles.mainContent}>
            ...
            <div className={styles.card}>
              <h2>Établissement</h2>
              <div className={styles.cardElem}>
                <h3>Orchestrez la Magie </h3>
                <p>
                  Créez l'événement qui vous ressemble et attirez l'élite
                  artistique. Lancez-vous, notre communauté d'artistes
                  passionnés n'attend que votre feu vert pour briller.
                </p>
              </div>
              <div className={styles.cardElem}>
                <h3>La Rencontre Parfaite</h3>
                <p>
                  Explorez, découvrez et sélectionnez votre coup de cœur parmi
                  une mosaïque de talents confirmés.
                </p>
              </div>
              <div className={styles.cardElem}>
                <h3>Dialogue Créatif</h3>
                <p>
                  Grâce à notre messagerie fluide et intuitive, discutez,
                  négociez et fixez les détails d'un partenariat harmonieux
